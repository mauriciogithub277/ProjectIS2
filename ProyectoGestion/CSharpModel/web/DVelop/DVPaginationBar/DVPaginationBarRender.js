...
function DVPaginationBar(userControl) {
	...
	this.render = function () {
		...
		if (this.control.PageCount === 0 || this.control.RecordCount === 0 || this.control.CurrentPage == 0) {
			...
			if (this.control.ChangePage && this.control.PageCount != null && this.control.CurrentPage > 1 && this.control.CurrentPage > this.control.PageCount && this.control.Page != 0) {
				var thisC = this;
				window.setTimeout(function () {
					if (thisC.control.ChangePage && thisC.control.PageCount != null && thisC.control.CurrentPage > 1 && thisC.control.CurrentPage > thisC.control.PageCount && this.control.Page != 0) {
	...
	this.renderPagingCaption = function (mainDiv) {
		if (this.control.Caption != '') {
			...
			if (this.control.PagingCaptionPosition == 'Center'
				&& this.control.PagingButtonsPosition == 'Center') {
				$(pagingCaptionDiv).css("float", "left");
			} else {
				if (this.control.PagingCaptionPosition == 'Center') {
					...
					$(pagingCaptionDiv).css("float", this.control.PagingCaptionPosition == 'Right' ? "right" : "left");
				}
			}
	...
	this.renderPagingButtons = function (mainDiv) {
		...
		if (this.control.PagingCaptionPosition == 'Center'
			...
			if (this.control.PagingButtonsPosition == 'Center') {
				...
				$(pagingMainDiv).css("float", this.control.PagingButtonsPosition == 'Right' ? "right" : "left");
			}
		}
