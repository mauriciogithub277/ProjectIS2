/*
       ...
       Generated on: 3/22/2020 21:2:16.8
...
namespace GeneXus.Programs {
   public class gx0070 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV13cProyectoNombre = GetNextPar( );
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cProyectoID, AV7cProyectoName, AV8cProyectoFecInicio, AV9cProyectoFecFin, AV10cProyectoEstado, AV13cProyectoNombre) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20203222121612", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCPROYECTONOMBRE", StringUtil.RTrim( AV13cProyectoNombre));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
      ...
      protected void WB0V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblproyectonombrefilter_Internalname, "Proyecto Nombre", "", "", lblLblproyectonombrefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e160v1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0070.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCproyectonombre_Internalname, "Proyecto Nombre", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 66,'',false,'" + sGXsfl_74_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCproyectonombre_Internalname, StringUtil.RTrim( AV13cProyectoNombre), StringUtil.RTrim( context.localUtil.Format( AV13cProyectoNombre, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCproyectonombre_Jsonclick, 0, "Attribute", "", "", "", "", edtavCproyectonombre_Visible, edtavCproyectonombre_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_Gx0070.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(74), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e170v1_client"+"'", TempTags, "", 2, "HLP_Gx0070.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCPROYECTONOMBRE"), AV13cProyectoNombre) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF0V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV6cProyectoID } ,
                                                 new int[]{
                                                 TypeConstants.STRING, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.DATE, TypeConstants.DATE, TypeConstants.STRING, TypeConstants.STRING,
                                                 TypeConstants.SHORT
                                                 }
            } ) ;
            ...
            lV13cProyectoNombre = StringUtil.PadR( StringUtil.RTrim( AV13cProyectoNombre), 40, "%");
            /* Using cursor H000V2 */
            pr_default.execute(0, new Object[] {AV6cProyectoID, lV7cProyectoName, AV8cProyectoFecInicio, AV9cProyectoFecFin, lV10cProyectoEstado, lV13cProyectoNombre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_74_idx = 1;
            sGXsfl_74_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_74_idx), 4, 0), 4, "0");
            SubsflControlProps_742( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A30ProyectoNombre = H000V2_A30ProyectoNombre[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_PROYECTOID"+"_"+sGXsfl_74_idx, GetSecureSignedToken( sGXsfl_74_idx, context.localUtil.Format( (decimal)(A16ProyectoID), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_fnc_Recordcount( )
      {
         ...
         lV13cProyectoNombre = StringUtil.PadR( StringUtil.RTrim( AV13cProyectoNombre), 40, "%");
         /* Using cursor H000V3 */
         pr_default.execute(1, new Object[] {AV6cProyectoID, lV7cProyectoName, AV8cProyectoFecInicio, AV9cProyectoFecFin, lV10cProyectoEstado, lV13cProyectoNombre});
      ...
      protected void STRUP0V0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13cProyectoNombre = cgiGet( edtavCproyectonombre_Internalname);
            AssignAttri("", false, "AV13cProyectoNombre", AV13cProyectoNombre);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20203222121656", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0070.js", "?20203222121656", false, true);
      ...
      protected void SubsflControlProps_742( )
      {
         ...
         edtProyectoFecFin_Internalname = "PROYECTOFECFIN_"+sGXsfl_74_idx;
         edtProyectoEstado_Internalname = "PROYECTOESTADO_"+sGXsfl_74_idx;
      }
      ...
      protected void SubsflControlProps_fel_742( )
      {
         ...
         edtProyectoFecFin_Internalname = "PROYECTOFECFIN_"+sGXsfl_74_fel_idx;
         edtProyectoEstado_Internalname = "PROYECTOESTADO_"+sGXsfl_74_fel_idx;
      }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cProyectoID',fld:'vCPROYECTOID',pic:'ZZZ9'},{av:'AV7cProyectoName',fld:'vCPROYECTONAME',pic:''},{av:'AV8cProyectoFecInicio',fld:'vCPROYECTOFECINICIO',pic:''},{av:'AV9cProyectoFecFin',fld:'vCPROYECTOFECFIN',pic:''},{av:'AV10cProyectoEstado',fld:'vCPROYECTOESTADO',pic:''},{av:'AV13cProyectoNombre',fld:'vCPROYECTONOMBRE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E170V1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         ...
         setEventMetadata("LBLPROYECTONOMBREFILTER.CLICK","{handler:'E160V1',iparms:[{av:'divProyectonombrefiltercontainer_Class',ctrl:'PROYECTONOMBREFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E200V2',iparms:[{av:'A16ProyectoID',fld:'PROYECTOID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         lV13cProyectoNombre = "";
         A30ProyectoNombre = "";
         H000V2_A30ProyectoNombre = new String[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0070__default(),
            new Object[][] {
                new Object[] {
               H000V2_A30ProyectoNombre, H000V2_A20ProyectoEstado, H000V2_A19ProyectoFecFin, H000V2_A18ProyectoFecInicio, H000V2_A17ProyectoName, H000V2_A16ProyectoID
               }
               , new Object[] {
      ...
      private String AV13cProyectoNombre ;
      ...
      private String lV13cProyectoNombre ;
      ...
      private String[] H000V2_A30ProyectoNombre ;
   ...
   public class gx0070__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cProyectoID )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [ProyectoNombre], [ProyectoEstado], [ProyectoFecFin], [ProyectoFecInicio], [ProyectoName], [ProyectoID]";
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13cProyectoNombre)) )
         {
            sWhereString = sWhereString + " and ([ProyectoNombre] like @lV13cProyectoNombre)";
         }
         else
         {
            GXv_int1[5] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000V2(context, (String)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (short)dynConstraints[10] );
               case 1 :
                     return conditional_H000V3(context, (String)dynConstraints[0] , (DateTime)dynConstraints[1] , (DateTime)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (String)dynConstraints[5] , (DateTime)dynConstraints[6] , (DateTime)dynConstraints[7] , (String)dynConstraints[8] , (String)dynConstraints[9] , (short)dynConstraints[10] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13cProyectoNombre",SqlDbType.NChar,40,0} ,
