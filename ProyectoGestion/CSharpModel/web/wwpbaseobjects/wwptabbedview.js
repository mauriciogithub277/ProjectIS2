/*!   GeneXus C# 16_0_7-138086 on 8/24/2020 21:27:47.83
*/
...
gx.define('wwpbaseobjects.wwptabbedview', true, function (CmpContext) {
   ...
   this.TabsgridContainer = new gx.grid.grid(this, 2,"WbpLvl2",14,"Tabsgrid","Tabsgrid","TabsgridContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.wwptabbedview",[],true,0,false,true,0,false,false,false,"",0,"px",0,"px",gx.getMessage( "GXM_newrow"),false,false,false,null,null,false,"",false,[1,1,1,1],false,0,false,false);
   var TabsgridContainer = this.TabsgridContainer;
   TabsgridContainer.startRow("","","top","","","");
   TabsgridContainer.startCell("","","bottom","","","","","","","");
   TabsgridContainer.addBitmap("Begintab","BEGINTAB",17,0,"",0,"",null,"","","Image","");
   ...
   TabsgridContainer.endCell();
   TabsgridContainer.endRow();
   this.TabsgridContainer.emptyText = gx.getMessage( "");
   ...
   this.AV5Tabs = [ ] ;
   this.AV7TabCode = "" ;
   this.Events = {"e12182_client": ["ENTER", true] ,"e13182_client": ["CANCEL", true]};
