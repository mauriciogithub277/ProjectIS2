/*
       ...
       Generated on: 8/24/2020 21:27:58.22
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class addressdisplay : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               AssignAttri("", false, "gxhash_vADDRESS", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV5Address, "")), context));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV6Geolocation = GetNextPar( );
                  AssignAttri("", false, "AV6Geolocation", AV6Geolocation);
                  AssignAttri("", false, "gxhash_vGEOLOCATION", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV6Geolocation, "")), context));
               }
            }
            if ( context.isSpaRequest( ) )
            {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202082421275824", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table1_2_132e( bool wbgen )
      {
         if ( wbgen )
         {
         }
      ...
      protected void E11132( )
      {
         ...
         {
            AV7LinkAddress = context.GetMessage( "http://maps.google.com?q=", "") + AV5Address + context.GetMessage( "&output=embed&iwloc=", "");
         }
         else
         {
            AV7LinkAddress = context.GetMessage( "http://maps.google.com/?q=", "") + AV6Geolocation + context.GetMessage( "&output=embed&z=16&iwloc=", "");
         }
      ...
      protected void wb_table1_2_132( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table2_5_132( true) ;
         }
         else
         {
            wb_table2_5_132( false) ;
         }
         return  ;
      }

      protected void wb_table2_5_132e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_5_132( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_5_132e( true) ;
         }
         else
         {
            wb_table2_5_132e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202082421275829", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwpbaseobjects/addressdisplay.js", "?202082421275830", false, true);
         }
