/*!   GeneXus C# 16_0_7-138086 on 8/24/2020 21:28:0.44
*/
...
gx.define('wwpbaseobjects.promptgeolocation', false, function () {
   ...
   GOOGLEMAPCONTROL1Container.setProp("Title", "Title", gx.getMessage( "Map Title"), "str");
   ...
   GXValidFnc[15]={ id: 15, fld:"BTNENTER",grid:0,evt:"e12162_client",std:"ENTER"};
   GXValidFnc[16]={ id: 16, fld:"BTNCANCEL",grid:0,evt:"e14161_client"};
   this.GxMapData = {MapType:"",MapZoom:0,MapLatitude:"",MapLongitude:"",Circles:[],Points:[],Polygons:[],Lines:[],Routing:[]} ;
   this.AV7Geolocation = "" ;
   this.AV10Latitude = "" ;
   this.AV11Longitude = "" ;
   this.Events = {"e12162_client": ["ENTER", true] ,"e14161_client": ["CANCEL", true]};
