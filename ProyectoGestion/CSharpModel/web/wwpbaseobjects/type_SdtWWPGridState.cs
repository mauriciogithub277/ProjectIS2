...
namespace GeneXus.Programs.wwpbaseobjects
{
	...
	[XmlType(TypeName="WWPGridState" , Namespace="IS2" )]
	[Serializable]
	...
	[DataContract(Name=@"WWPGridState", Namespace="IS2")]
	public class SdtWWPGridState_RESTInterface : GxGenericCollectionItem<SdtWWPGridState>, System.Web.SessionState.IRequiresSessionState
	{
		...
		[DataMember(Name="FilterValues", Order=5, EmitDefaultValue=false)]
		...
		[DataMember(Name="DynamicFilters", Order=6, EmitDefaultValue=false)]
