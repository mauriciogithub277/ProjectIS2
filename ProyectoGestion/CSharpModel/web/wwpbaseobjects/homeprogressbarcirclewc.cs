/*
               File: WWPBaseObjects.HomeProgressBarCircleWC
        Description: Home Progress Bar Circle WC
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 8/24/2020 21:27:49.43
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class homeprogressbarcirclewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202082421274945", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm192( )
      {
         ...
         {
            context.AddJavascriptSource("wwpbaseobjects/homeprogressbarcirclewc.js", "?202082421274948", false, true);
         }
      ...
      protected void STRUP190( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            Ucpb_Percentage = (int)(context.localUtil.CToN( cgiGet( sPrefix+"UCPB_Percentage"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")));
            Ucpb_Circlewidth = (int)(context.localUtil.CToN( cgiGet( sPrefix+"UCPB_Circlewidth"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")));
            Ucpb_Circleprogresswidth = (int)(context.localUtil.CToN( cgiGet( sPrefix+"UCPB_Circleprogresswidth"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202082421274963", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/homeprogressbarcirclewc.js", "?202082421274963", false, true);
            context.AddJavascriptSource("DVelop/Bootstrap/DVProgressIndicator/DVProgressIndicatorRender.js", "", false, true);
         }
