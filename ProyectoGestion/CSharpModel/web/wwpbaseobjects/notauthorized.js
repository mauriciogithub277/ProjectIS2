/*!   GeneXus C# 16_0_7-138086 on 8/25/2020 17:59:58.87
*/
...
gx.define('wwpbaseobjects.notauthorized', false, function () {
   ...
   GXValidFnc[20]={ id: 20, fld:"LOGINAGAIN", format:0,grid:0,evt:"e12072_client"};
   GXValidFnc[23]={ id: 23, fld:"TORETURN", format:0,grid:0};
   GXValidFnc[25]={ id: 25, fld:"RETURN", format:0,grid:0};
   this.GxObject = "" ;
   this.Events = {"e12072_client": ["LOGINAGAIN.CLICK", true] ,"e14072_client": ["ENTER", true] ,"e15072_client": ["CANCEL", true]};
