/*!   GeneXus C# 16_0_7-138086 on 8/24/2020 21:28:0.6
*/
...
gx.define('wwpbaseobjects.savefilteras', false, function () {
   ...
   GXValidFnc[17]={ id: 17, fld:"BTNENTER",grid:0,evt:"e12172_client",std:"ENTER"};
   GXValidFnc[18]={ id: 18, fld:"BTNCANCEL",grid:0,evt:"e14171_client"};
   this.AV8FilterName = "" ;
   this.ZV8FilterName = "" ;
   this.OV8FilterName = "" ;
   this.AV8FilterName = "" ;
   ...
   this.Events = {"e12172_client": ["ENTER", true] ,"e14171_client": ["CANCEL", true]};
