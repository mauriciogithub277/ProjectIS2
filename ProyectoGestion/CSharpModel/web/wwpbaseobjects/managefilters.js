/*!   GeneXus C# 16_0_7-138086 on 8/25/2020 17:59:58.64
*/
...
gx.define('wwpbaseobjects.managefilters', false, function () {
   ...
   this.GridgridstatecollectionsContainer = new gx.grid.grid(this, 2,"WbpLvl2",15,"Gridgridstatecollections","Gridgridstatecollections","GridgridstatecollectionsContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.managefilters",[],false,1,false,true,0,true,false,false,"CollWWPBaseObjects\GridStateCollection.Item",0,"px",0,"px",gx.getMessage( "GXM_newrow"),true,false,false,null,null,false,"AV7GridStateCollection",false,[1,1,1,1],false,0,true,false);
   var GridgridstatecollectionsContainer = this.GridgridstatecollectionsContainer;
   GridgridstatecollectionsContainer.addBitmap("&Moveup","vMOVEUP",16,0,"px",17,"px","e14152_client","","","ActionBaseColorAttribute","WWActionColumn");
   GridgridstatecollectionsContainer.addBitmap("&Movedown","vMOVEDOWN",17,0,"px",17,"px","e15152_client","","","ActionBaseColorAttribute","WWActionColumn");
   GridgridstatecollectionsContainer.addSingleLineEdit("GXV2",18,"GRIDSTATECOLLECTION__TITLE",gx.getMessage( "WWP_FiltersColumnName"),"","Title","svchar",0,"px",100,80,"left",null,[],"GXV2","GXV2",true,0,false,false,"AttributeManageFilters",1,"WWColumn");
   GridgridstatecollectionsContainer.addSingleLineEdit("GXV3",19,"GRIDSTATECOLLECTION__GRIDSTATEXML",gx.getMessage( "Grid State XML"),"","GridStateXML","vchar",0,"px",2097152,80,"left",null,[],"GXV3","GXV3",false,0,false,false,"Attribute",1,"WWColumn");
   GridgridstatecollectionsContainer.addBitmap("&Udelete","vUDELETE",20,0,"px",17,"px","e16152_client","","","DeleteAttribute","WWActionColumn");
   this.GridgridstatecollectionsContainer.emptyText = gx.getMessage( "");
   ...
   GXValidFnc[16]={ id:16 ,lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:15,gxgrid:this.GridgridstatecollectionsContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vMOVEUP",gxz:"ZV16MoveUp",gxold:"OV16MoveUp",gxvar:"AV16MoveUp",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){if(Value!==undefined)gx.O.AV16MoveUp=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV16MoveUp=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vMOVEUP",row || gx.fn.currentGridRowImpl(15),gx.O.AV16MoveUp,gx.O.AV32Moveup_GXI)},c2v:function(row){gx.O.AV32Moveup_GXI=this.val_GXI();if(this.val(row)!==undefined)gx.O.AV16MoveUp=this.val(row)},val:function(row){return gx.fn.getGridControlValue("vMOVEUP",row || gx.fn.currentGridRowImpl(15))},val_GXI:function(row){return gx.fn.getGridControlValue("vMOVEUP_GXI",row || gx.fn.currentGridRowImpl(15))}, gxvar_GXI:'AV32Moveup_GXI',nac:gx.falseFn,evt:"e14152_client"};
   GXValidFnc[17]={ id:17 ,lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:15,gxgrid:this.GridgridstatecollectionsContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vMOVEDOWN",gxz:"ZV15MoveDown",gxold:"OV15MoveDown",gxvar:"AV15MoveDown",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){if(Value!==undefined)gx.O.AV15MoveDown=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV15MoveDown=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vMOVEDOWN",row || gx.fn.currentGridRowImpl(15),gx.O.AV15MoveDown,gx.O.AV33Movedown_GXI)},c2v:function(row){gx.O.AV33Movedown_GXI=this.val_GXI();if(this.val(row)!==undefined)gx.O.AV15MoveDown=this.val(row)},val:function(row){return gx.fn.getGridControlValue("vMOVEDOWN",row || gx.fn.currentGridRowImpl(15))},val_GXI:function(row){return gx.fn.getGridControlValue("vMOVEDOWN_GXI",row || gx.fn.currentGridRowImpl(15))}, gxvar_GXI:'AV33Movedown_GXI',nac:gx.falseFn,evt:"e15152_client"};
   ...
   GXValidFnc[20]={ id:20 ,lvl:2,type:"bits",len:1024,dec:0,sign:false,ro:1,isacc:0,grid:15,gxgrid:this.GridgridstatecollectionsContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vUDELETE",gxz:"ZV6UDelete",gxold:"OV6UDelete",gxvar:"AV6UDelete",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',v2v:function(Value){if(Value!==undefined)gx.O.AV6UDelete=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV6UDelete=Value},v2c:function(row){gx.fn.setGridMultimediaValue("vUDELETE",row || gx.fn.currentGridRowImpl(15),gx.O.AV6UDelete,gx.O.AV34Udelete_GXI)},c2v:function(row){gx.O.AV34Udelete_GXI=this.val_GXI();if(this.val(row)!==undefined)gx.O.AV6UDelete=this.val(row)},val:function(row){return gx.fn.getGridControlValue("vUDELETE",row || gx.fn.currentGridRowImpl(15))},val_GXI:function(row){return gx.fn.getGridControlValue("vUDELETE_GXI",row || gx.fn.currentGridRowImpl(15))}, gxvar_GXI:'AV34Udelete_GXI',nac:gx.falseFn,evt:"e16152_client"};
   GXValidFnc[21]={ id: 21, fld:"",grid:0};
   GXValidFnc[22]={ id: 22, fld:"",grid:0};
   GXValidFnc[23]={ id: 23, fld:"",grid:0};
   GXValidFnc[24]={ id: 24, fld:"",grid:0};
   GXValidFnc[25]={ id: 25, fld:"BTNENTER",grid:0,evt:"e11152_client",std:"ENTER"};
   GXValidFnc[26]={ id: 26, fld:"",grid:0};
   GXValidFnc[27]={ id: 27, fld:"BTNCANCEL",grid:0,evt:"e17151_client"};
   ...
   this.Events = {"e11152_client": ["ENTER", true] ,"e14152_client": ["VMOVEUP.CLICK", true] ,"e15152_client": ["VMOVEDOWN.CLICK", true] ,"e16152_client": ["VUDELETE.CLICK", true] ,"e17151_client": ["CANCEL", true]};
