/*
       ...
       Generated on: 8/24/2020 21:27:48.15
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wizardstepsarrowwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202082421274820", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm112( )
      {
         ...
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsarrowwc.js", "?202082421274824", false, true);
         }
      ...
      protected void E11112( )
      {
         ...
         AssignAttri(sPrefix, false, sPrefix+"gxhash_vSTEPNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV14StepNumber), "ZZZ9"), context));
         AV15StepRealNumber = 1;
         AssignAttri(sPrefix, false, "AV15StepRealNumber", StringUtil.LTrimStr( (decimal)(AV15StepRealNumber), 4, 0));
         AssignAttri(sPrefix, false, sPrefix+"gxhash_vSTEPREALNUMBER", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(AV15StepRealNumber), "ZZZ9"), context));
         AV9PreviousSelected = false;
         AssignAttri(sPrefix, false, "AV9PreviousSelected", AV9PreviousSelected);
         AssignAttri(sPrefix, false, sPrefix+"gxhash_vPREVIOUSSELECTED", GetSecureSignedToken( sPrefix, AV9PreviousSelected, context));
         AV5FirstIsDummy = false;
         AssignAttri(sPrefix, false, "AV5FirstIsDummy", AV5FirstIsDummy);
         AssignAttri(sPrefix, false, sPrefix+"gxhash_vFIRSTISDUMMY", GetSecureSignedToken( sPrefix, AV5FirstIsDummy, context));
         AV10SecondIsDummy = false;
         AssignAttri(sPrefix, false, "AV10SecondIsDummy", AV10SecondIsDummy);
         AssignAttri(sPrefix, false, sPrefix+"gxhash_vSECONDISDUMMY", GetSecureSignedToken( sPrefix, AV10SecondIsDummy, context));
         AV8PenultimateIsDummy = false;
         AssignAttri(sPrefix, false, "AV8PenultimateIsDummy", AV8PenultimateIsDummy);
         AssignAttri(sPrefix, false, sPrefix+"gxhash_vPENULTIMATEISDUMMY", GetSecureSignedToken( sPrefix, AV8PenultimateIsDummy, context));
         AV6LastIsDummy = false;
         AssignAttri(sPrefix, false, "AV6LastIsDummy", AV6LastIsDummy);
         AssignAttri(sPrefix, false, sPrefix+"gxhash_vLASTISDUMMY", GetSecureSignedToken( sPrefix, AV6LastIsDummy, context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202082421274852", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/wizardstepsarrowwc.js", "?202082421274853", false, true);
         }
      ...
      {
         AV18WizardSteps = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "IS2");
         wcpOAV11SelectedStep = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         AV19WizardStepsAux = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWizardSteps_WizardStepsItem>( context, "WizardStepsItem", "IS2");
         GXKey = "";
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
