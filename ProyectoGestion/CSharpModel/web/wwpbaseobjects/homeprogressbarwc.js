/*!   GeneXus C# 16_0_7-138086 on 8/24/2020 21:27:47.88
*/
...
gx.define('wwpbaseobjects.homeprogressbarwc', true, function (CmpContext) {
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV6Percentage=gx.fn.getIntegerValue("vPERCENTAGE",gx.thousandSeparator) ;
   };
   ...
   GXValidFnc[9]={ id: 9, fld:"DESCRIPTIONPROGRESSBAR1", format:0,grid:0};
   GXValidFnc[10]={ id: 10, fld:"",grid:0};
   GXValidFnc[11]={ id: 11, fld:"",grid:0};
   GXValidFnc[13]={ id: 13, fld:"",grid:0};
   GXValidFnc[14]={ id: 14, fld:"",grid:0};
   GXValidFnc[15]={ id: 15, fld:"",grid:0};
   GXValidFnc[16]={ id:16 ,lvl:0,type:"svchar",len:20,dec:0,sign:false,ro:1,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"vOPTIONTITLE",gxz:"ZV5OptionTitle",gxold:"OV5OptionTitle",gxvar:"AV5OptionTitle",ucs:[],op:[],ip:[],
