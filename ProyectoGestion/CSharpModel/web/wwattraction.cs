...
namespace GeneXus.Programs {
   public class wwattraction : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwattraction( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13AttractionName, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vATTRACTIONNAME", StringUtil.RTrim( AV13AttractionName));
         /* Send saved values. */
         send_integrity_footer_hashes( ) ;
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Attractions", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWAttraction.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavAttractionname_Internalname, "Attraction Name", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavAttractionname_Internalname, StringUtil.RTrim( AV13AttractionName), StringUtil.RTrim( context.localUtil.Format( AV13AttractionName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Name", edtavAttractionname_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavAttractionname_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A4AttractionID), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A5AttractionName));
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtAttractionName_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A6AttractionAddress);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A7AttractionPhone));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vATTRACTIONNAME"), AV13AttractionName) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13AttractionName = StringUtil.PadR( StringUtil.RTrim( AV13AttractionName), 20, "%");
            /* Using cursor H000D2 */
            pr_default.execute(0, new Object[] {lV13AttractionName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A7AttractionPhone = H000D2_A7AttractionPhone[0];
               A6AttractionAddress = H000D2_A6AttractionAddress[0];
               A5AttractionName = H000D2_A5AttractionName[0];
               A4AttractionID = H000D2_A4AttractionID[0];
               E140D2 ();
      ...
      protected void send_integrity_lvl_hashes0D2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV19Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV19Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_ATTRACTIONID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A4AttractionID), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13AttractionName = StringUtil.PadR( StringUtil.RTrim( AV13AttractionName), 20, "%");
         /* Using cursor H000D3 */
         pr_default.execute(1, new Object[] {lV13AttractionName});
      ...
      protected void STRUP0D0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13AttractionName = cgiGet( edtavAttractionname_Internalname);
            AssignAttri("", false, "AV13AttractionName", AV13AttractionName);
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("attraction.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A4AttractionID);
         edtavDelete_Link = formatLink("attraction.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A4AttractionID);
         edtAttractionName_Link = formatLink("viewattraction.aspx") + "?" + UrlEncode("" +A4AttractionID) + "," + UrlEncode(StringUtil.RTrim(""));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("attraction.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13AttractionName = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               AssignAttri("", false, "AV13AttractionName", AV13AttractionName);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13AttractionName;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Attraction";
      ...
      {
         edtAttractionID_Internalname = "ATTRACTIONID_"+sGXsfl_25_idx;
         edtAttractionName_Internalname = "ATTRACTIONNAME_"+sGXsfl_25_idx;
         edtAttractionAddress_Internalname = "ATTRACTIONADDRESS_"+sGXsfl_25_idx;
         edtAttractionPhone_Internalname = "ATTRACTIONPHONE_"+sGXsfl_25_idx;
      ...
      {
         edtAttractionID_Internalname = "ATTRACTIONID_"+sGXsfl_25_fel_idx;
         edtAttractionName_Internalname = "ATTRACTIONNAME_"+sGXsfl_25_fel_idx;
         edtAttractionAddress_Internalname = "ATTRACTIONADDRESS_"+sGXsfl_25_fel_idx;
         edtAttractionPhone_Internalname = "ATTRACTIONPHONE_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtAttractionID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A4AttractionID), 4, 0, ".", "")),context.localUtil.Format( (decimal)(A4AttractionID), "ZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtAttractionID_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"ID",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtAttractionAddress_Internalname,(String)A6AttractionAddress,(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A6AttractionAddress),(String)"_blank",(String)"",(String)"",(String)edtAttractionAddress_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)1024,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"GeneXus\\Address",(String)"left",(bool)true,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV13AttractionName',fld:'vATTRACTIONNAME',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140D2',iparms:[{av:'A4AttractionID',fld:'ATTRACTIONID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtAttractionName_Link',ctrl:'ATTRACTIONNAME',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110D2',iparms:[{av:'A4AttractionID',fld:'ATTRACTIONID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13AttractionName',fld:'vATTRACTIONNAME',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13AttractionName',fld:'vATTRACTIONNAME',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13AttractionName',fld:'vATTRACTIONNAME',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13AttractionName',fld:'vATTRACTIONNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13AttractionName = "";
         H000D2_A7AttractionPhone = new String[] {""} ;
         H000D2_A6AttractionAddress = new String[] {""} ;
         H000D2_A5AttractionName = new String[] {""} ;
         H000D2_A4AttractionID = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwattraction__default(),
            new Object[][] {
                new Object[] {
               H000D2_A7AttractionPhone, H000D2_A6AttractionAddress, H000D2_A5AttractionName, H000D2_A4AttractionID
               }
               , new Object[] {
      ...
      private String AV13AttractionName ;
      ...
      private String lV13AttractionName ;
      ...
      private String[] H000D2_A7AttractionPhone ;
      private String[] H000D2_A6AttractionAddress ;
      private String[] H000D2_A5AttractionName ;
      private short[] H000D2_A4AttractionID ;
   ...
   public class wwattraction__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A5AttractionName )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [AttractionPhone], [AttractionAddress], [AttractionName], [AttractionID]";
         sFromString = " FROM [Attraction]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13AttractionName)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and ([AttractionName] like @lV13AttractionName)";
            }
            else
            {
               sWhereString = sWhereString + " ([AttractionName] like @lV13AttractionName)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY [AttractionName]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13AttractionName",SqlDbType.NChar,20,0} ,
