/*
               File: ViewAttraction
        Description: View Attraction
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 3/13/2020 18:2:19.38
...
namespace GeneXus.Programs {
   public class viewattraction : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12AttractionID = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12AttractionID", StringUtil.LTrimStr( (decimal)(AV12AttractionID), 4, 0));
               AssignAttri("", false, "gxhash_vATTRACTIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12AttractionID), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20203131821941", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewattraction.aspx") + "?" + UrlEncode("" +AV12AttractionID) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("AttractionName", StringUtil.RTrim( context.localUtil.Format( A5AttractionName, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLog("viewattraction:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Attractionsupplierwc == null ) )
         {
            WebComp_Attractionsupplierwc.componentjscripts();
         }
      }
      ...
      {
         return formatLink("viewattraction.aspx") + "?" + UrlEncode("" +AV12AttractionID) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }
      ...
      protected void WB0C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Attraction Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Attractions", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewAttraction.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtAttractionName_Internalname, StringUtil.RTrim( A5AttractionName), StringUtil.RTrim( context.localUtil.Format( A5AttractionName, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAttractionName_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtAttractionName_Enabled, 0, "text", "", 20, "chr", 1, "row", 20, 0, 0, 0, 1, -1, -1, true, "Name", "left", true, "", "HLP_ViewAttraction.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewAttraction.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblAttractionsupplier_title_Internalname, "Attraction Supplier", "", "", lblAttractionsupplier_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewAttraction.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "AttractionSupplier") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABContainer"+"panel2"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divTableattractionsupplier_Internalname, 1, 0, "px", 0, "px", "TabsFormContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Attractionsupplierwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0038"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Attractionsupplierwc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldAttractionsupplierwc), StringUtil.Lower( WebComp_Attractionsupplierwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0038"+"");
                  }
                  WebComp_Attractionsupplierwc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldAttractionsupplierwc), StringUtil.Lower( WebComp_Attractionsupplierwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldAttractionsupplierwc = cgiGet( "W0038");
                           if ( ( StringUtil.Len( OldAttractionsupplierwc) == 0 ) || ( StringUtil.StrCmp(OldAttractionsupplierwc, WebComp_Attractionsupplierwc_Component) != 0 ) )
                           {
                              WebComp_Attractionsupplierwc = getWebComponent(GetType(), "GeneXus.Programs", OldAttractionsupplierwc, new Object[] {context} );
                              WebComp_Attractionsupplierwc.ComponentInit();
                              WebComp_Attractionsupplierwc.Name = "OldAttractionsupplierwc";
                              WebComp_Attractionsupplierwc_Component = OldAttractionsupplierwc;
                           }
                           if ( StringUtil.Len( WebComp_Attractionsupplierwc_Component) != 0 )
                           {
                              WebComp_Attractionsupplierwc.componentprocess("W0038", "", sEvt);
                           }
                           WebComp_Attractionsupplierwc_Component = OldAttractionsupplierwc;
                        }
                     }
      ...
      protected void RF0C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Attractionsupplierwc_Component) != 0 )
               {
                  WebComp_Attractionsupplierwc.componentstart();
               }
            }
         }
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A4AttractionID = H000C2_A4AttractionID[0];
               A5AttractionName = H000C2_A5AttractionName[0];
      ...
      protected void STRUP0C0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12AttractionID = (short)(context.localUtil.CToN( cgiGet( "vATTRACTIONID"), ".", ","));
            ...
            {
               GXUtil.WriteLog("viewattraction:[ SecurityCheckFailed value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110C2( )
      {
         ...
         {
            A4AttractionID = H000C3_A4AttractionID[0];
            A5AttractionName = H000C3_A5AttractionName[0];
            AssignAttri("", false, "A5AttractionName", A5AttractionName);
            AV16GXLvl6 = 1;
            Form.Caption = A5AttractionName;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12AttractionID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "AttractionSupplier") == 0 ) )
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Attractionsupplierwc_Component), StringUtil.Lower( "AttractionAttractionSupplierWC")) != 0 )
            {
               WebComp_Attractionsupplierwc = getWebComponent(GetType(), "GeneXus.Programs", "attractionattractionsupplierwc", new Object[] {context} );
               WebComp_Attractionsupplierwc.ComponentInit();
               WebComp_Attractionsupplierwc.Name = "AttractionAttractionSupplierWC";
               WebComp_Attractionsupplierwc_Component = "AttractionAttractionSupplierWC";
            }
            if ( StringUtil.Len( WebComp_Attractionsupplierwc_Component) != 0 )
            {
               WebComp_Attractionsupplierwc.setjustcreated();
               WebComp_Attractionsupplierwc.componentprepare(new Object[] {(String)"W0038",(String)"",(short)AV12AttractionID});
               WebComp_Attractionsupplierwc.componentbind(new Object[] {(String)""});
            }
            if ( isFullAjaxMode( ) )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0038"+"");
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Attractionsupplierwc == null ) )
         {
            if ( StringUtil.Len( WebComp_Attractionsupplierwc_Component) != 0 )
            {
               WebComp_Attractionsupplierwc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20203131821963", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewattraction.js", "?20203131821963", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         lblAttractionsupplier_title_Internalname = "ATTRACTIONSUPPLIER_TITLE";
         divTableattractionsupplier_Internalname = "TABLEATTRACTIONSUPPLIER";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12AttractionID',fld:'vATTRACTIONID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A5AttractionName',fld:'ATTRACTIONNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         OldGeneralwc = "";
         lblAttractionsupplier_title_Jsonclick = "";
         WebComp_Attractionsupplierwc_Component = "";
         OldAttractionsupplierwc = "";
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         sEvtType = "";
         AV15Pgmname = "";
         scmdbuf = "";
         H000C2_A4AttractionID = new short[1] ;
         H000C2_A5AttractionName = new String[] {""} ;
         hsh = "";
         H000C3_A4AttractionID = new short[1] ;
         H000C3_A5AttractionName = new String[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewattraction__default(),
            new Object[][] {
                new Object[] {
               H000C2_A4AttractionID, H000C2_A5AttractionName
               }
               , new Object[] {
               H000C3_A4AttractionID, H000C3_A5AttractionName
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Attractionsupplierwc = new GeneXus.Http.GXNullWebComponent();
         AV15Pgmname = "ViewAttraction";
         /* GeneXus formulas. */
         AV15Pgmname = "ViewAttraction";
         context.Gx_err = 0;
      ...
      private String lblAttractionsupplier_title_Internalname ;
      private String lblAttractionsupplier_title_Jsonclick ;
      private String divTableattractionsupplier_Internalname ;
      private String WebComp_Attractionsupplierwc_Component ;
      private String OldAttractionsupplierwc ;
      private String sEvt ;
      ...
      private GXWebComponent WebComp_Attractionsupplierwc ;
      private GXProperties forbiddenHiddens ;
      private GXUserControl ucTab ;
      private IGxDataStore dsDefault ;
      private IDataStoreProvider pr_default ;
      private short[] H000C2_A4AttractionID ;
      private String[] H000C2_A5AttractionName ;
      private short[] H000C3_A4AttractionID ;
      private String[] H000C3_A5AttractionName ;
   ...
   public class viewattraction__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12AttractionID",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH000C3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000C2", "SELECT [AttractionID], [AttractionName] FROM [Attraction] WHERE [AttractionID] = @AV12AttractionID ORDER BY [AttractionID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000C3", "SELECT [AttractionID], [AttractionName] FROM [Attraction] WHERE [AttractionID] = @AV12AttractionID ORDER BY [AttractionID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000C3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
