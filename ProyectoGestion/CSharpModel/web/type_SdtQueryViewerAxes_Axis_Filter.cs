...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="QueryViewerAxes.Axis.Filter" , Namespace="IS2" )]
	[Serializable]
	public class SdtQueryViewerAxes_Axis_Filter : GxUserType
	{
		...
		public GxSimpleCollection<String> gxTpr_Values_GxSimpleCollection
		{
			...
			set {
				...
				gxTv_SdtQueryViewerAxes_Axis_Filter_Values_N = 0;
		...
		{
			gxTv_SdtQueryViewerAxes_Axis_Filter_Values_N = 1;
		...
		{
				return gxTv_SdtQueryViewerAxes_Axis_Filter_Values != null && gxTv_SdtQueryViewerAxes_Axis_Filter_Values.Count > 0;
		...
		protected short gxTv_SdtQueryViewerAxes_Axis_Filter_Values_N;
	...
	[DataContract(Name=@"QueryViewerAxes.Axis.Filter", Namespace="IS2")]
