/*!   GeneXus C# 16_0_7-138086 on 8/25/2020 17:59:51.63
*/
...
gx.define('rwdrecentlinks', true, function (CmpContext) {
   ...
   this.LinksContainer = new gx.grid.grid(this, 2,"WbpLvl2",8,"Links","Links","LinksContainer",this.CmpContext,this.IsMasterPage,"rwdrecentlinks",[],true,9999,false,true,0,false,false,false,"",0,"px",0,"px",gx.getMessage( "GXM_newrow"),false,false,false,null,null,false,"",true,[1,0,0,0],false,0,false,false);
   ...
   LinksContainer.endDiv();
   LinksContainer.endDiv();
   this.LinksContainer.emptyText = gx.getMessage( "");
   this.setGrid(LinksContainer);
   GXValidFnc[2]={ id: 2, fld:"",grid:0};
   GXValidFnc[3]={ id: 3, fld:"MAINTABLE",grid:0};
   GXValidFnc[4]={ id: 4, fld:"",grid:0};
   GXValidFnc[5]={ id: 5, fld:"",grid:0};
   GXValidFnc[6]={ id: 6, fld:"RECENTTEXT", format:0,grid:0,evt:"e11051_client"};
   GXValidFnc[7]={ id: 7, fld:"",grid:0};
   GXValidFnc[9]={ id: 9, fld:"LINKSTABLE",grid:8};
   GXValidFnc[10]={ id: 10, fld:"",grid:8};
   GXValidFnc[11]={ id: 11, fld:"",grid:8};
   GXValidFnc[12]={ id: 12, fld:"PLACE", format:0,grid:8};
   this.AV6FormCaption = "" ;
   this.AV7FormPgmName = "" ;
